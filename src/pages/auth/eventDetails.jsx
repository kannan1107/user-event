        ...
        <div className="p-8">
          ...
          <div className="border-t pt-6 mb-6">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-gray-500 text-sm">- Your rating: {userRating ? `${userRating.rating} ★` : 'Not rated yet'}</span>
              <div className="ml-auto">{userRating?.review && <p className="text-sm text-gray-600 italic">Your review: "{userRating.review}"</p>}</div>
            </div>
          ...
          {event?.ratings?.length > 0 && (
            <div className="border-t pt-6 mb-6">
              <h2 className="text-2xl font-bold mb-4">What others are saying</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {event.ratings.map((r, index) => (
                  <div key={index} className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                    ...
                    {r.review ? (
                      <p className="text-gray-700 italic text-sm">"{r.review}"</p>
                    ) : (
